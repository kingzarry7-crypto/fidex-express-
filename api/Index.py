...
def admin_login(
    ...
    print("====================================")
    print("FIDEX ADMIN LOGIN ATTEMPT")
    print("Received email:", repr(x_admin_email))
    print("Received password length:", len(x_admin_password or ""))
    print("Configured email:", repr(ADMIN_EMAIL))
    print("Configured password length:", len(ADMIN_PASSWORD))
    print("====================================")
